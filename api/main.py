...
from api.routers import customers, conversations, chat, documents, discovery, knowledge_base
...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:3000",
        "http://127.0.0.1:3000",
        # Add your Railway / production domain here, e.g.:
        # "https://aws-finserv-assistant.up.railway.app",
    ],
